...
<head>
	...
	<script type="text/javascript" src="<c:url value='../resources/admin/apt/ntc/js/aptNtcWrite.js'/>"></script>
	</c:if>
				...
				<div class="container-fluid">
					...
					<div class="mb-4 page-heading-div">
						...
						<div class="page-heading-title-div">
							<span class="mb-0 text-gray-800 page-heading-title">공지 작성</span> 
								
							&nbsp; &nbsp; &nbsp;
								
								
							<span class="page-heading-navi-span"><i class="fas fa-fw fa-home"></i> > 공지 작성</span> 
						</div>
