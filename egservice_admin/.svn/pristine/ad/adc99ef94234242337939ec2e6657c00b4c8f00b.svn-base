...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		...
		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:url value='../pop/aptHome'/>" id="logo"
		 style="background-image: url('../../resources/images/geumcheongu_logo.jpg'); background-repeat: no-repeat; background-size:224px;">
		</a>
		
		<hr class="sidebar-divider my-0">
		
		<li class="nav-item apt-home" id='apt-home'>
			<a class="nav-link" href="<c:url value='../pop/aptHome'/> "> 
		...
		<li class="nav-item apt-usage">
			...
			<div id="apt-usage" class="collapse show" aria-labelledby="headingConstructionManagement" data-parent="#accordionSidebar">
				<div class="py-2 collapse-inner rounded">
					...
					<a id="sub-day" class="collapse-item collapse-item-white" href="<c:url value='../pop/aptUsageDay' />">날짜별 사용량 비교</a>
					<a id="sub-month" class="collapse-item collapse-item-white" href="<c:url value='../pop/aptUsageMonth' />">월별 사용량 비교</a>
		...
		<li class="nav-item apt-member">
			<a class="nav-link" href="<c:url value='../pop/aptMemberList'/> "> 
