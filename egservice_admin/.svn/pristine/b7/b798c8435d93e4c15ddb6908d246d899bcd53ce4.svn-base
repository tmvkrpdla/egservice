...
public class PageUtil {
	 ...
	 * 
	 * // 0 부터 시작 int idx = (nowPage-1) * listCount;
	 * 
	 * //idx = (nowPage-1) * listCount +1;
	 * 
	 * return idx; }
	 * 
	 * public int getLastIdx() { int idx = 0;
	 * 
	 * if(totalCount> nowPage * listCount ) {
	 * 
	 * idx = nowPage * listCount-1;
	 * 
	 * }else { idx = totalCount-1; }
	 * 
	 * 
	 * return idx; }//
	 */	
