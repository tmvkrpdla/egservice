...
<head>
	...
	<script src="../resources/admin/apt/ntc/js/aptNtcList.js"></script>
	</c:if>
				...
				<div class="container-fluid">
					...
					<div class="mb-4 page-heading-div">
						...
						<div class="page-heading-title-div">
							<span class="mb-0 text-gray-800 page-heading-title">공지 사항</span> 
								
							&nbsp; &nbsp; &nbsp;
								
								
							<span class="page-heading-navi-span"><i class="fas fa-fw fa-home"></i> > 공지 사항</span> 
						</div>
												...
												<tbody>
													<c:forEach items="${NOTICE_LIST}" var="NOTICE_LIST">
														<c:if test="${NOTICE_LIST.is_top eq 1 }">
															<tr class='aptNoticeListIsTop'>

																<td class='noticeListEvt aptNoticeTitle'>
																	<c:if test="${NOTICE_LIST.is_top eq 1 }">
																		<img src="../resources/images/headpin.png" class='noticeHeadPin'>
																	</c:if>
														...
														<c:if test="${NOTICE_LIST.is_top ne 1 }">
															<tr>
																...
																<td class='noticeListEvt aptNoticeTitle'>${NOTICE_LIST.title}
											...
											<div class="dataTables_paginate paging_simple_numbers"
												...
												<c:if test="${PAGEUTIL.startPage eq 1}">
													...
													<li class="paginate_button page-item previous" id="">
														<a href="../apt/ntcList?nowPage=${PAGEUTIL.startPage - 1 }" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">
															<
														</a>
													</li>			
													</c:if>
													...
													<li class="paginate_button page-item" id="">
														<a href="../apt/ntcList?nowPage=1" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">
															1
														</a>
													</li>			
													</c:if>
													...
													<li class="paginate_button page-item" id="">
														<a href="../apt/ntcList?nowPage=${page}" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">
															${page}
														</a>
													</li>			
													</c:forEach>
													...
													<li class="paginate_button page-item next" id="dataTable_previous">
														<a href="../apt/ntcList?nowPage=${PAGEUTIL.endPage+1}" class="page-link">
															>
														</a>
													</li>		
													</c:if>
