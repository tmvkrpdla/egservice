...
<c:if test="${not empty sessionScope}">
	...
	<script src="${pageContext.request.contextPath}/resources/admin/bld/comp/js/bldCompWeek.js"></script>
							...
							<div class="card shadow mb-4">
								<div class="card-body">
									<div style="width:100%;display: inline-block;">
										<form id="searchForm" name="searchForm" method="get" action="<c:url value='../bld/compWeek'/>">
