...
<meta name="viewport"
	...
	<script src="${pageContext.request.contextPath}/resources/admin/bld/elec/js/bldElecPopActMod.js"></script>
	

	<script type="text/javascript">
		$(document).ready(function() {
			
			var id3 = opener.window.$(".mod").val();
						...
						<div class="col-xl-12">
							<div class="card shadow mb-4">
								<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
									<h6 class="m-0 font-weight-bold text-primary">절감 조치 수정하기</h6>
											...
											<div style="width:100%;">
												...
												<div style="width:100%;">
													...
													<div style="width:100%;padding-bottom:65px;">
														<div style='width:80%;float:left;'>
															<input type='hidden' name='seq_save_act' class='seq_save_act' id="seq_save_act">
												...
												<div style="width:100%;">
													<div style='padding-bottom:5px;width: 100%;text-align: right;'>  
														<input type="button" value='수정' class='btn btn-outline-success btn-sm' id='actModBtn'>
													</div>
												</div>
