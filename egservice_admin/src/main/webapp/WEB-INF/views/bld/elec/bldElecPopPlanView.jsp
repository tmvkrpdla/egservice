...
<meta name="viewport"
	...
	<script src="${pageContext.request.contextPath}/resources/admin/bld/elec/js/bldElecPopPlanView.js"></script>
						...
						<div class="col-xl-12">
							<div class="mb-4 page-heading-div">
								...
								<div class="page-heading-title-div">
									<span class="mb-0 text-gray-800 page-heading-title">절감 계획 상세 보기</span> 
									
									&nbsp &nbsp &nbsp
									
									<span class="page-heading-navi-span"><i class="fas fa-fw fa-home"></i> > 절감 계획 목록 조회 > 절감 계획 상세 보기</span>
								</div>
											...
											<div class="col-xl-12">
												<table class="table-hover org-table-bordered org-table-style" id="dataTable">
													<tr class="org-table-title-usage">
														<td style="width: 15%;">계측기</td>
														<td style="width: 15%;">절감 시간</td>
														<td style="width: 15%;">절감 목표</td>
														<td style="width: 15%;">예상 절감량</td>
														<td style="width: 15%;">예상 절감 요금</td>
														<td style="width: 25%;">절감 조치</td>
													</tr>

													<c:forEach items="${SAVE_RESULT_DAILY.list_plan_elem}" var="LIST_PLAN_ELEM">

														<tr>
															<td>${LIST_PLAN_ELEM.meter_descr}</td>
															<td>${LIST_PLAN_ELEM.hour_from}시~${LIST_PLAN_ELEM.hour_to}시</td>
															<td>${LIST_PLAN_ELEM.percent_to_save}%</td>
															<td><fmt:formatNumber value="${LIST_PLAN_ELEM.save_kwh}" pattern="#,##0.00" /></td>
															<td><fmt:formatNumber value="${LIST_PLAN_ELEM.save_won}" pattern="#,##0.00" /></td>
															<td style="text-align: left;">
																<c:forEach items="${LIST_PLAN_ELEM.list_act}" var="LIST_ACT">
																	 &nbsp· ${LIST_ACT.act_content} <br>
																</c:forEach>
																</td>	
														</tr>
