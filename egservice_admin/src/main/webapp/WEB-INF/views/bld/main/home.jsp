...
<title>EG Service</title>

<jsp:include page="../../common/common.jsp"></jsp:include>

<c:if test="${not empty sessionScope}">
	<script src="${pageContext.request.contextPath}/resources/admin/bld/main/js/bldMainHome.js"></script>
							...
							<div class="col-xl-12">
								<div class="mb-4a page-heading-div">
									...
									<div class="page-heading-title-div">
										...
										&nbsp; &nbsp; &nbsp; <span class="page-heading-navi-span"><i
								...
								<div class="card shadow mb-4">
									...
									<div class="card-body3">
										...
										<div class="row">
											...
											<div class="col-lg-3 col-sm-6">
												면적 | <span id="site_area"><fmt:formatNumber
														type="number" pattern="#,###.00"
														value="${SITE_INFO_BLD.area}" />㎡ </span>
											</div>
											<div class="col-lg-3 col-sm-6">
												완공일 | <span id="site_built_year">${SITE_INFO_BLD.built_year}</span>
												- <span id="site_built_month">${SITE_INFO_BLD.built_month}</span>
											</div>
											<div class="col-lg-3 col-sm-6">
												홈페이지 | <span id="site_home_page"> <a
													href="${SITE_INFO_BLD.home_page}" target="_blank">
														${SITE_INFO_BLD.home_page} </a>
												</span>
												<%-- <a href="${BLD_SITE_INFO.home_page}" target="_blank"> ${BLD_SITE_INFO.home_page} </a> --%>
											</div>
										</div>
										...
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												<div class="font-weight-bold text-primary mb-1 font-size-20">
													사용량 (kWh)</div>
												<div
													class="mb-0 font-weight-bold text-gray-800 font-size-17"
													id="sum"></div>
											</div>
											<div class="col-auto">
										...
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div
													class="mb-0 font-weight-bold text-gray-800 font-size-17"
													id="">
													<span id="delta_sum_img"></span> <span id="delta_sum"></span>
												</div>
											</div>
										</div>
										...
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div
													class="mb-0 font-weight-bold text-gray-800 font-size-17"
													id="">
													<span id="delta_carbon_img"></span> <span id="delta_carbon"></span>
												</div>
											</div>
											<!-- <div class="col-auto">
								...
								<div class="card shadow mb-4">
									<div class="card-body">
										...
										<div class="lightbulb-text-style">
											<div>
												<div style="width: 50%; float: left">- 사용량은 계측기 사용량의
													합계입니다.</div>
												<div style="width: 50%; float: right; text-align: right;">
													<span id="get_api_time"></span> <span id="refreshBtn"
														style="cursor: pointer;"> <i class="fas fa-redo"></i>
													</span>
												</div>
											</div>

											<div>- 사용량 수집 주기는 15분입니다.</div>

											<div>- 30일 평균 사용량은 30일 전부터 어제까지 사용량의 평균입니다. (근무일과 휴무일
												구분)</div>

											<div>- 사용량 증감은 오늘 사용량과 30일 평균값의 차이입니다.</div>
