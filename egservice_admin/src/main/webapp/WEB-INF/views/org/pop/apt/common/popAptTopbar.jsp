	...
	<form class="d-none d-sm-inline-block">
		<div class="input-group">
			...
			<span class='top-bar-font-size'>
				${sessionScope.ADMIN.team_name } > ${sessionScope.SITE_INFO_BLD.name}
			</span>
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow top-bar-font-size">
			...
			<div style="display: block;padding: 0.5rem 1rem;"> 
				<span class="mr-2 d-lg-inline text-gray-600 small">${sessionScope.ADMIN.admin_name} (${sessionScope.ADMIN.admin_id}) 님
					...
					<!-- popup SITE_MAP -->
					<input type="hidden" id="seq_site" value="${sessionScope.SITE_INFO_BLD.seq_site}">
