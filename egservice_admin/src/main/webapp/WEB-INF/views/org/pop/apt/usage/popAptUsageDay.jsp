...
<meta name="viewport"
	...
	<title>세대간 사용량 비교 > 날짜별 사용량 비교</title>
	...
	<script src="${pageContext.request.contextPath}/resources/admin/org/pop/apt/usage/js/popAptUsageDay.js"></script>	
				...
				<div class="container-fluid">
					...
					<div class="mb-4 page-heading-div">
						...
						<div class="page-heading-title-div">
							<span class="mb-0 text-gray-800 page-heading-title">날짜별 사용량 비교</span> 
								
							&nbsp; &nbsp; &nbsp;
								
								
							<span class="page-heading-navi-span"><i class="fas fa-fw fa-home"></i> > 세대간 사용량 비교 > 날짜별 사용량 비교</span> 
						</div>
							...
							<div class="card shadow mb-4">
								<div class="card-body">
									<div style="width:100%;display: inline-block;">				
										<form id="searchForm" name="searchForm" method="get" action="<c:url value='../pop/aptUsageDay'/>">
