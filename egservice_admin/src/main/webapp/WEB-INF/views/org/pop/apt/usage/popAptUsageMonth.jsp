...
<meta name="viewport"
	...
	<script src="${pageContext.request.contextPath}/resources/admin/org/pop/apt/usage/js/popAptUsageMonth.js"></script>
							...
							<div class="card shadow mb-4">
								<div class="card-body">
									<div style="width:100%;display: inline-block;">				
										<form id="searchForm" name="searchForm" method="get" action="<c:url value='../pop/aptUsageMonth'/>">
