...
<c:if test="${not empty sessionScope}">
	...
	<script src="${pageContext.request.contextPath}/resources/admin/org/pop/bld/comp/js/popBldCompDay.js"></script>
							...
							<div class="card shadow mb-4">
								<div class="card-body">
									<div style="width:100%;display: inline-block;">													
										<form id="searchForm" name="searchForm" method="get" action="<c:url value='./bldCompDay'/>">
									...
									<c:forEach items="${USAGE_METER_DAY_LIST}" var="USAGE_METER_DAY_LIST">
										<table class="table-hover org-table-bordered org-table-style">
											...
											<c:forEach items="${USAGE_METER_DAY_LIST.list_usage}" var="LIST_USAGE" varStatus="STATUS">
												...
												<td style="width:calc(100%/13)">${LIST_USAGE.unit + 1} 시</td>
												</c:if>
											</c:forEach>
											</tr>
